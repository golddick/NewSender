...
// import { Search, Eye, Flag, TrendingUp, FileText, AlertTriangle, Calendar, ThumbsUp, MessageCircle } from "lucide-react"
...
//     authorEmail: "sarah.j@thenews.com",
//     status: "published",
//     category: "Marketing",
...
//     authorEmail: "m.brown@thenews.com",
//     status: "published",
//     category: "Strategy",
...
//   {
//     id: "blog_003",
//     title: "Advanced Analytics for Email Performance",
//     author: "Emily Davis",
//     authorEmail: "emily.d@thenews.com",
//     status: "draft",
//     category: "Analytics",
...
//   {
//     id: "blog_004",
//     title: "Controversial Marketing Tactics That Work",
//     author: "David Wilson",
//     authorEmail: "d.wilson@thenews.com",
//     status: "published",
//     category: "Marketing",
//     tags: ["Controversial", "Tactics", "Growth"],
//     publishedAt: "2024-01-16T13:30:00Z",
//     views: 2100,
//     likes: 156,
//     comments: 78,
//     isFlagged: true,
//     flagReason: "Content may violate community guidelines - aggressive marketing tactics",
//     createdAt: "2024-01-15T09:00:00Z",
//   },
//   {
//     id: "blog_005",
//     title: "GDPR Compliance in Email Marketing",
//     author: "Lisa Anderson",
//     authorEmail: "l.anderson@thenews.com",
//     status: "scheduled",
//     category: "Legal",
...
//   const filteredData = mockBlogData.filter((post) => {
//     const matchesSearch =
...
//     published: mockBlogData.filter((post) => post.status === "published").length,
//     draft: mockBlogData.filter((post) => post.status === "draft").length,
//     flagged: mockBlogData.filter((post) => post.isFlagged).length,
//     totalViews: mockBlogData.reduce((sum, post) => sum + post.views, 0),
//   }
...
//           <CardDescription>
//             Showing {filteredData.length} of {mockBlogData.length} posts
//           </CardDescription>
//         </CardHeader>
//         <CardContent>
...
import { deleteBlogPost, fetchAllBlogPosts, resolveBlogPostFlag, updateBlogPostStatus } from "@/actions/blog/superAdmin"
