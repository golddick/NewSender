...
//       uploadedAt: "2024-01-21T10:25:00Z",
//       verified: false,
//     },
//     {
//       id: "doc_002",
...
//       uploadedAt: "2024-01-21T10:26:00Z",
//       verified: false,
//     },
//     {
//       id: "doc_003",
...
//       uploadedAt: "2024-01-21T10:28:00Z",
//       verified: false,
//     },
//     {
//       id: "doc_004",
...
//       description: `KYC application ${kycId} has been approved successfully.`,
//     })
...
//       description: `KYC application ${kycId} has been rejected.`,
//       variant: "destructive",
//     })
...
//       normal: { label: "Normal Priority", className: "bg-blue-100 text-blue-800 border-blue-200" },
//       low: { label: "Low Priority", className: "bg-gray-100 text-gray-800 border-gray-200" },
//     }
...
//             </Link>
//           </div>
//           <h1 className="text-3xl font-bold">KYC Review: {mockKycData.fullName}</h1>
//           <p className="text-muted-foreground">Application ID: {mockKycData.id}</p>
//         </div>

//         <div className="flex items-center space-x-2">
//           {getStatusBadge(mockKycData.status)}
//           {getPriorityBadge(mockKycData.priority)}
//         </div>
//       </div>
...
//               <div className="flex items-center space-x-2">
//                 <Progress value={mockKycData.completionScore} className="flex-1" />
//                 <span className="text-sm font-medium">{mockKycData.completionScore}%</span>
//               </div>
//             </div>
...
//                 <span className="font-medium">{mockKycData.documents.length} uploaded</span>
//               </div>
//             </div>

//             <div className="space-y-2">
//               <Label className="text-sm font-medium text-muted-foreground">Submitted</Label>
//               <p className="font-medium">{new Date(mockKycData.submittedAt).toLocaleDateString()}</p>
//             </div>

//             <div className="space-y-2">
//               <Label className="text-sm font-medium text-muted-foreground">Priority Level</Label>
//               <p className="font-medium capitalize">{mockKycData.priority}</p>
//             </div>
//           </div>
//         </CardContent>
//       </Card>
...
//                 <p className="font-medium">{mockKycData.fullName}</p>
//               </div>

//               <div>
//                 <Label className="text-sm font-medium text-muted-foreground">Date of Birth</Label>
//                 <p className="font-medium">{new Date(mockKycData.dateOfBirth).toLocaleDateString()}</p>
//               </div>
//             </div>
...
//                 <p className="font-medium">{mockKycData.email}</p>
//               </div>
//             </div>
...
//                 <p className="font-medium">{mockKycData.phone}</p>
//               </div>
//             </div>
...
//                 <p className="font-medium font-mono">{mockKycData.idNumber}</p>
//               </div>
//             </div>
...
//                 <div>
//                   <p className="font-medium">{mockKycData.address.street}</p>
//                   <p className="text-sm text-muted-foreground">
//                     {mockKycData.address.city}, {mockKycData.address.state} {mockKycData.address.zipCode}
//                   </p>
//                   <p className="text-sm text-muted-foreground">{mockKycData.address.country}</p>
//                 </div>
//               </div>
//             </div>
//           </CardContent>
...
//               {mockKycData.documents.map((document) => (
//                 <div key={document.id} className="flex items-center justify-between p-3 border rounded-lg">
//                   <div className="flex items-center space-x-3">
//                     {document.type === "Live Photo" ? (
...
//                           {document.type === "Live Photo" || document.filename.includes(".jpg") ? (
//                             <img
//                               src={`/placeholder.svg?height=400&width=600&text=${document.type}`}
//                               alt={document.type}
...
//       {/* Review Actions */}
//       {mockKycData.status === "pending" || mockKycData.status === "under_review" ? (
//         <Card>
//           <CardHeader>
//             <CardTitle className="flex items-center space-x-2">
...
//                       <DialogDescription>
//                         Are you sure you want to approve this KYC application? The user will be notified and granted
//                         full access.
//                       </DialogDescription>
//                     </DialogHeader>
...
//                       <DialogDescription>
//                         Are you sure you want to reject this KYC application? The user will be notified with the reason
//                         provided.
//                       </DialogDescription>
//                     </DialogHeader>
//                     <div className="flex justify-end space-x-2">
...
//         <CardContent>
//           <div className="space-y-4">
//             {mockKycData.reviewHistory.map((entry, index) => (
...
//                   {entry.comment && <p className="text-sm mt-1 p-2 bg-gray-50 rounded">{entry.comment}</p>}
//                 </div>
//               </div>
//             ))}
//           </div>
...
import { fetchKycById, updateKycStatus } from "@/actions/kyc/superAdmin"
import { transformKYCData } from "@/app/dashboard/settings/_component/transformKYCData"
...
export function KycReview({ kycId }: KycReviewProps) {
  ...
  const fetchKycData = async () => {
    try {
      ...
      toast({
        title: "Error",
        description: error instanceof Error ? error.message : "Failed to fetch KYC data",
        variant: "destructive",
      })
      setKycData(null)
    } finally {
  ...
  const handleStatusUpdate = async (status: "APPROVED" | "REJECTED", comment?: string) => {
    try {
      ...
      toast({
        ...
        description: `KYC application has been ${status.toLowerCase()} successfully.`,
