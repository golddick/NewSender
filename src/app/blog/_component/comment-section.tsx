...
const CommentItem: React.FC<CommentItemProps> = ({
  ...
  return (
    <motion.div
      ...
      className={`${isReply ? "ml-8 border-l-2 border-blue-100 pl-6" : ""} ${depth > 2 ? "ml-4" : ""}`}
    >
    ...
    <div className="bg-white rounded-2xl shadow-lg p-8 border border-neutral-200">
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-3">
          ...
          <h3 className="text-2xl font-bold text-neutral-900">Comments ({totalComments})</h3>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="text-sm border border-neutral-200 rounded-lg px-3 py-1 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500"
          >
      ...
      {/* New Comment Form */}
      <div className="mb-8 p-6 bg-gradient-to-r from-white to-gold-50 rounded-xl border border-blue-100">
        ...
        <form onSubmit={handleNewCommentSubmit} className="space-y-4">
          ...
          <div className="flex justify-between items-center">
            <p className="text-sm text-neutral-500">Be respectful and constructive in your comments.</p>
