...
//             <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
//               <Badge className="mb-4 bg-white/20 text-white border-white/30 hover:bg-white/30 capitalize">{category.name}</Badge>
//               <h1 className="text-2xl lg:text-4xl font-bold mb-6 leading-tight capitalize">{title}</h1>
...
//                 alt={title}
//                 fill
//                 className="  object-none transition-transform duration-300 hover:scale-105"
//               />
...
//                   <Button variant="ghost" size="sm" onClick={() => open('facebook')} className="text-blue-600 hover:bg-blue-50">
//                     <Facebook className="h-4 w-4" />
//                   </Button>
//                   <Button variant="ghost" size="sm" onClick={() => open('twitter')} className="text-blue-400 hover:bg-blue-50">
//                     <Twitter className="h-4 w-4" />
//                   </Button>
//                   <Button variant="ghost" size="sm" onClick={() => open('linkedin')} className="text-blue-700 hover:bg-blue-50">
//                     <Linkedin className="h-4 w-4" />
//                   </Button>
//                     {/* WhatsApp */}
//                   <Button   variant="ghost" size="sm" className="text-blue-400 hover:bg-blue-50" onClick={() => open('whatsapp')}>
