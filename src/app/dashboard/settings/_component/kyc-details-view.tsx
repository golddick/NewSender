...
//                 <Button onClick={onResubmit} size="sm" className="bg-red-500 hover:bg-red-600 text-white">
...
export function KYCDetailsView({ kycData, onEdit, onResubmit }: KYCDetailsViewProps) {
  ...
  return (
    <div className="space-y-6 px-4 sm:px-6 py-4 md:max-w-7xl mx-auto  h-full overflow-y-scroll ">
      {/* Status Overview */}
