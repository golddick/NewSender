...
export function SubscriptionSettings() {
  ...
  return (
    <div className="space-y-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto mb-4">
      ...
      <div>
        {/* <h2 className="text-xl sm:text-2xl font-bold tracking-tight mb-2">Subscription & Billing</h2>
        <p className="text-sm sm:text-base text-muted-foreground mb-6">Manage your subscription plan, billing, and payment methods.</p> */}
