...
const FooterNewsLetter = () => {
  ...
  // ✅ Hardcoded values
  const integrationId = 'clx123integrationid'; // Replace with actual integration ID
  const campaignId = 'clx456campaignid'; // Replace with actual campaign ID
  ...
  const handleSubscribe = async () => {
    ...
    try {
      ...
      const res = await axios.post('https://denews-xi.vercel.app/api/subscribers', payload);
