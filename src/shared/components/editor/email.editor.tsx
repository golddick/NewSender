...
const EmailEditorPage = ({ subjectTitle }: { subjectTitle: string }) => {
  ...
  return (
    <div className="w-full h-full relative p-2 md:p-4 space-y-4">
      {/* Email Type Selection */}
      ...
      <div className="w-full h-full border shadow-sm rounded-lg p-4 bg-white">
        ...
        <div className="h-[500px] sm:h-[600px] rounded-md overflow-hidden border">
          <EmailEditor ref={emailEditorRef} onReady={onReady} />
        </div>
      </div>

      {/* Send Button */}
      <div className="bg-white p-4 rounded-lg border shadow-sm sticky bottom-0 z-10">
        <Button
          className="w-full"
          color="primary"
