            ...
            try {
              ...
              if (trackClicks) {
                enhancedContent = enhancedContent.replace(
                  /href="([^"]+)"/g,
                  (_, url) => 
                    `href="${domain}/api/track-notification/click?notificationId=${emailId}&email=${encodeURIComponent(email)}&url=${encodeURIComponent(url)}&tid=${trackingId}"`
                );
              }

              // Add open tracking
              if (trackOpens) {
                enhancedContent += `<img src="${domain}/api/track-notification/open?notificationId=${emailId}&email=${encodeURIComponent(email)}&tid=${trackingId}" width="1" height="1" style="display:none" />`;
              }
...
//                 enhancedContent = enhancedContent.replace(
//                   /href="([^"]+)"/g,
//                   (_, url) => `href="${domain}/api/track-notification-mail/click?notificationId=${emailId}&email=${encodeURIComponent(email)}&url=${encodeURIComponent(url)}&tid=${trackingId}"`
//                 );
//               }

//               if (trackOpens) {
//                 enhancedContent += `<img src="${domain}/api/track-notification-mail/open?notificationId=${emailId}&email=${encodeURIComponent(email)}&tid=${trackingId}" width="1" height="1" style="display:none" />`;
//               }
