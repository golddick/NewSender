/*
  ...
  - The values [newUser] on the enum `CampaignTrigger` will be removed. If these variants are still used in the database, this will fail.
  - You are about to drop the column `subject` on the `Campaign` table. All the data in the column will be lost.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "CampaignTrigger_new" AS ENUM ('new_user', 'Subscriber', 'unsubscribe', 'notification');
